...
\texttt{check26} (an assertion gate re-deriving and asserting every numerical
claim made in this paper and in \cite{LuiI}).

Several of the earlier scripts report data rather than assertions, so running
them cannot detect a regression; \texttt{check26} exists to close that gap and
is the script to run first.
