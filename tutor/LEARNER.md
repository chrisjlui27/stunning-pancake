...
- Doing research-level work on the mirror sedenions (own paper, separate
  vault on branch `claude/code-vs-cowork-comparison-vsh2mf`; the tutor does
  not edit it). The computations there are machine-verified; the goal is for
  the learner to be able to prove what they currently compute.
